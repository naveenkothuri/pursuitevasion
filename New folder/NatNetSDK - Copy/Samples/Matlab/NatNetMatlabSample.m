...
function NatNetMatlabSample()
    ...
    try
        ...
        dllPath = fullfile(curDir,'lib','x64','NatNetML.dll');
...
%                 q = quaternion( rigidBodyData.x, rigidBodyData.y, rigidBodyData.z, rigidBodyData.qw );
...
%                 angleZ = -angles(3) * 180.0 / pi;   % must invert due to 180 flip above
                  ...
                  angleX=rigidBodyData.x*1000;
                  angleY=rigidBodyData.y*1000;
                  angleZ=rigidBodyData.z*1000;
