###########################################################################
## Makefile generated for Simulink model 'lego_move_optitrack3'. 
## 
## Makefile     : lego_move_optitrack3.mk
## Generated on : Tue Aug 08 12:12:03 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lego_move_optitrack3
...
PRODUCT_NAME              = lego_move_optitrack3
MAKEFILE                  = lego_move_optitrack3.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = lego_move_optitrack3_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lego_move_optitrack3
...
DEFINES_ = -DMODEL=lego_move_optitrack3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=lego_move_optitrack3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = lego_move_optitrack3.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_ultrasonic_sensor.o
...
%.o : $(START_DIR)/lego_move_optitrack3_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/lego_move_optitrack3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
