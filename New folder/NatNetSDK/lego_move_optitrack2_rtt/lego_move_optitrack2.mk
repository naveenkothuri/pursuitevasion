# File name: lego_move_optitrack2.mk
# Autogenerated on: 13-Feb-2017 11:44:56
# Copyright 2009-2011 The MathWorks, Inc.
#
# Model: LEGO_MOVE_OPTITRACK2
# Template: gmake 
# Template Version: 1.0 
# Tool Chain Configuration: EV3
# Tool Chain Configuration Version: 1.0

THIS_MAKEFILE        := $(lastword $(MAKEFILE_LIST))
EMPTY                :=
SPACE                := $(EMPTY) $(EMPTY)
MODEL_NAME           := lego_move_optitrack2
...
MATLAB_ROOT_RELATIVE := C:\Program Files\MATLAB\MATLAB Production Server\R2015a\#MATLAB_ROOT_RELATIVE_END
...
SOURCE_FILES        := $(call FORMAT_PATH,.\driver_ev3_lcd.c) $(call FORMAT_PATH,.\driver_ev3_motor.c) $(call FORMAT_PATH,.\ext_svr.c) $(call FORMAT_PATH,.\ext_work.c) $(call FORMAT_PATH,.\rtiostream_interface.c) $(call FORMAT_PATH,.\updown.c) $(call FORMAT_PATH,.\rtiostream_tcpip.c) $(call FORMAT_PATH,.\rtiostream_utils.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\lego_move_optitrack2.c) $(call FORMAT_PATH,.\lego_move_optitrack2_data.c)
HEADER_FILES        := $(call FORMAT_PATH,C:\Program Files\MATLAB\MATLAB Production Server\R2015a\rtw\c\src\ext_mode\common\ext_svr.h) $(call FORMAT_PATH,C:\Program Files\MATLAB\MATLAB Production Server\R2015a\rtw\c\src\ext_mode\common\ext_work.h) $(call FORMAT_PATH,C:\Program Files\MATLAB\MATLAB Production Server\R2015a\rtw\c\src\ext_mode\common\updown.h) $(call FORMAT_PATH,C:\Program Files\MATLAB\MATLAB Production Server\R2015a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.h) $(call FORMAT_PATH,.\lego_move_optitrack2.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2015a/legomindstormsev3/toolbox/realtime/targets/ev3/include" -I"E:/academics/thesis/NatNetSDK/lego_move_optitrack2_rtt" -I"E:/academics/thesis/NatNetSDK" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/extern/include" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/simulink/include" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/ert" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/toolbox/coder/rtiostream/src/utils" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src/rtiostream/rtiostreamtcpip" -D"MODEL=lego_move_optitrack2" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ON_TARGET_WAIT_FOR_START=1" -D"ONESTEPFCN=0" -D"EXT_MODE=1" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=0" -D"EXIT_FAILURE=1" -D"EXTMODE_DISABLEPRINTF=" -D"EXTMODE_DISABLETESTING=" -D"EXTMODE_DISABLE_ARGS_PROCESSING=1"
COMPILER_TCCFG_ARGS   := -I"C:\MATLAB\SupportPackages\R2015a\CodeSourcery\arm-none-linux-gnueabi\libc\usr\include" -I"C:\MATLAB\SupportPackages\R2015a\CodeSourcery\lib\gcc\arm-none-linux-gnueabi\4.4.1\include" -I"C:\MATLAB\SupportPackages\R2015a\CodeSourcery\lib\gcc\arm-none-linux-gnueabi\4.4.1\include-fixed" -I"C:\MATLAB\SupportPackages\R2015a\EV3Source" -c -nostdinc
COMPILER_ARGS         := $(COMPILER_CODEGEN_ARGS) $(COMPILER_TCCFG_ARGS)
LINKER_CODEGEN_ARGS   := 
LINKER_TCCFG_ARGS     := -LC:\MATLAB\SupportPackages\R2015a\CodeSourcery\arm-none-linux-gnueabi\libc\lib -lm  -lpthread -lrt -o $(TARGET)
...
COMPILER           ?= $(subst \,/,C:\MATLAB\SupportPackages\R2015a\CodeSourcery\bin\arm-none-linux-gnueabi-gcc)
LINKER             ?= $(subst \,/,C:\MATLAB\SupportPackages\R2015a\CodeSourcery\bin\arm-none-linux-gnueabi-gcc)
PREBUILD_TOOL      ?= 
POSTBUILD_TOOL     ?= 
